    ...
    <div class="divTableRow">
      <div class="divTableCell">
        <header class="divTable">
          <div class="divTableRow">
            <div class="divTableCell siteInfo"><svg aria-hidden="true" height="50" viewBox="0 0 24 24" version="1.1" width="50" data-view-component="true" class="siteLogo">
...
</svg><strong class="siteTitle">فروشگاه ایرانیان</strong></div>
          </div>
        </header>
