...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jul 31, 2024 at 04:33 PM
...
CREATE TABLE IF NOT EXISTS `messages` (
  `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'کد پیام',
  `realname` varchar(70) COLLATE utf8_persian_ci NOT NULL COMMENT 'نام کامل',
  `email` varchar(50) COLLATE utf8_persian_ci NOT NULL COMMENT 'پست الکترونیک',
  `content` text COLLATE utf8_persian_ci NOT NULL COMMENT 'متن پیام',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_persian_ci COMMENT='جدول پیامها';
...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  `orderdate` varchar(20) COLLATE utf8_persian_ci NOT NULL COMMENT 'تاریخ سفارش',
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_persian_ci COMMENT='جدول سفارشات';
...
(1, 'almasi', '1403/05/10', 9, 7, 120000, '09306178128', 'ØªÙ‡Ø±Ø§Ù†ØŒ Ø´Ù‡Ø±Ø§Ù†ØŒ Ø®ÛŒØ§Ø¨Ø§Ù† Ø¬Ù‡Ø§Ø¯ØŒ Ù¾Ù„Ø§Ú© 300 ÙˆØ§Ø­Ø¯ 8', '145543342956394292759822', 1),
(2, 'arsalan', '1403/05/11', 6, 2, 140000, '09194809301', 'ØªÙ‡Ø±Ø§Ù†ØŒ Ø¨Ù„ÙˆØ§Ø± Ø´Ù‡Ø¯Ø§ØŒ Ø®ÛŒØ§Ø¨Ø§Ù† Ú©Ø§Ø¬ØŒ Ø±Ùˆ Ø¨Ù‡ Ø±ÙˆÛŒ Ø¯Ø¨ÛŒØ±Ø³ØªØ§Ù† Ø§Ù„ÙˆÙ†Ø¯ Ù¾Ù„Ø§Ú© 18 ÙˆØ§Ø­Ø¯ 20', '727993337375246779695843', 0);
...
CREATE TABLE IF NOT EXISTS `products` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1118 DEFAULT CHARSET=utf8 COLLATE=utf8_persian_ci COMMENT='جدول کالاها';
...
(2, 'Ø­Ù‚Ù‡ Ø¬ÙˆÚ© Ú©Ø§Ø±ÛŒ', 1, 1650000, 'hoghe-jukkari.jpg', 'Ø§ÛŒÙ† Ø­Ù‚Ù‡ Ø­Ø§ÙˆÛŒ Ù‡Ù†Ø± Ø§ØµÛŒÙ„ Ø§ÛŒØ±Ø§Ù†ÛŒ Ø¨Ù‡ Ù†Ø§Ù… Ø¬ÙˆÚ© Ú©Ø§Ø±ÛŒ Ø§Ø³Øª. Ø§ÛŒÙ† Ù‡Ù†Ø± Ø§Ø² Ø³Ø®Øª ØªØ±ÛŒÙ† Ù‡Ù†Ø± Ù‡Ø§ÛŒ Ø§ÛŒØ±Ø§Ù†ÛŒ Ø§Ø³Øª.  Ù…Ø¯Ø§Ø¯ Ø±Ù†Ú¯ÛŒ Ù‡Ø§ Ù…Ø´ØºÙˆÙ„ Ø¨ÙˆØ¯Ù†Ø¯ Ø¨Ù‡ Ø¬Ø² Ù…Ø¯Ø§Ø¯ Ø³ÙÛŒØ¯ØŒ Ù‡ÛŒÚ†Ú©Ø³ Ø¨Ù‡ Ø§Ùˆ Ú©Ø§Ø± Ù†Ù…ÛŒØ¯Ø§Ø¯ØŒ Ù‡Ù…Ù‡ Ù…ÛŒÚ¯ÙØªÙ†Ø¯ : ØªÙˆ Ø¨Ù‡ Ù‡ÛŒÚ† Ø¯Ø±Ø¯ÛŒ Ù†Ù…ÛŒØ®ÙˆØ±ÛŒØŒ ÛŒÚ© Ø´Ø¨ Ú©Ù‡ Ù…Ø¯Ø§Ø¯ Ø±Ù†Ú¯ÛŒ Ù‡Ø§ ØªÙˆ Ø³ÛŒØ§Ù‡ÛŒ Ø´Ø¨ Ú¯Ù… Ø´Ø¯Ù‡ Ø¨ÙˆØ¯Ù†Ø¯ØŒ Ù…Ø¯Ø§Ø¯ Ø³ÙÛŒØ¯ ØªØ§ ØµØ¨Ø­ Ù…Ø§Ù‡ Ú©Ø´ÛŒØ¯ Ù…Ù‡ØªØ§Ø¨ Ú©Ø´ÛŒØ¯ Ùˆ Ø§Ù†Ù‚Ø¯Ø± Ø³ØªØ§Ø±Ù‡ Ú©Ø´ÛŒØ¯ Ú©Ù‡ Ú©ÙˆÚ†Ú© Ùˆ Ú©ÙˆÚ†Ú©ØªØ± Ø´Ø¯ ØµØ¨Ø­ ØªÙˆÛŒ Ø¬Ø¹Ø¨Ù‡ Ù…Ø¯Ø§Ø¯ Ø±Ù†Ú¯ÛŒ Ø¬Ø§ÛŒ Ø®Ø§Ù„ÛŒ Ø§Ùˆ Ø¨Ø§ Ù‡ÛŒÚ† Ø±Ù†Ú¯ÛŒ  Ù¾Ø± Ù†Ø´Ø¯ØŒ Ø¨Ù‡ ÛŒØ§Ø¯ Ù‡Ù… Ø¨Ø§Ø´ÛŒÙ… Ø´Ø§ÛŒØ¯ ÙØ±Ø¯Ø§ Ù…Ø§ Ù‡Ù… Ø¯Ø± Ú©Ù†Ø§Ø± Ù‡Ù… Ù†Ø¨Ø§Ø´ÛŒÙ…â€¦'),
(3, 'Ø­Ù‚Ù‡ Ø®Ø§ØªÙ… Ú©Ø§Ø±ÛŒ', 5, 450000, 'hoghe-khatamkari.jpg', 'Ø§ÛŒÙ† Ø­Ù‚Ù‡ Ø®Ø§ØªÙ… Ú©Ø§Ø±ÛŒ Ø´Ø¯Ù‡ Ø§Ø² Ù…Ø±ØºÙˆØ¨ ØªØ±ÛŒÙ† Ù†ÙˆØ¹ Ú†ÙˆØ¨ ØªÙ‡ÛŒÙ‡ Ø´Ø¯Ù‡ Ùˆ Ù…Ø­ØµÙˆÙ„ Ø³Ø§Ø¹Øª Ù‡Ø§ Ø²Ø­Ù…Øª Ùˆ Ø®Ø³ØªÚ¯ÛŒ Ø§Ø³Øª.  Ù…Ø¯Ø§Ø¯ Ø±Ù†Ú¯ÛŒ Ù‡Ø§ Ù…Ø´ØºÙˆÙ„ Ø¨ÙˆØ¯Ù†Ø¯ Ø¨Ù‡ Ø¬Ø² Ù…Ø¯Ø§Ø¯ Ø³ÙÛŒØ¯ØŒ Ù‡ÛŒÚ†Ú©Ø³ Ø¨Ù‡ Ø§Ùˆ Ú©Ø§Ø± Ù†Ù…ÛŒØ¯Ø§Ø¯ØŒ Ù‡Ù…Ù‡ Ù…ÛŒÚ¯ÙØªÙ†Ø¯ : ØªÙˆ Ø¨Ù‡ Ù‡ÛŒÚ† Ø¯Ø±Ø¯ÛŒ Ù†Ù…ÛŒØ®ÙˆØ±ÛŒØŒ ÛŒÚ© Ø´Ø¨ Ú©Ù‡ Ù…Ø¯Ø§Ø¯ Ø±Ù†Ú¯ÛŒ Ù‡Ø§ ØªÙˆ Ø³ÛŒØ§Ù‡ÛŒ Ø´Ø¨ Ú¯Ù… Ø´Ø¯Ù‡ Ø¨ÙˆØ¯Ù†Ø¯ØŒ Ù…Ø¯Ø§Ø¯ Ø³ÙÛŒØ¯ ØªØ§ ØµØ¨Ø­ Ù…Ø§Ù‡ Ú©Ø´ÛŒØ¯ Ù…Ù‡ØªØ§Ø¨ Ú©Ø´ÛŒØ¯ Ùˆ Ø§Ù†Ù‚Ø¯Ø± Ø³ØªØ§Ø±Ù‡ Ú©Ø´ÛŒØ¯ Ú©Ù‡ Ú©ÙˆÚ†Ú© Ùˆ Ú©ÙˆÚ†Ú©ØªØ± Ø´Ø¯ ØµØ¨Ø­ ØªÙˆÛŒ Ø¬Ø¹Ø¨Ù‡ Ù…Ø¯Ø§Ø¯ Ø±Ù†Ú¯ÛŒ Ø¬Ø§ÛŒ Ø®Ø§Ù„ÛŒ Ø§Ùˆ Ø¨Ø§ Ù‡ÛŒÚ† Ø±Ù†Ú¯ÛŒ  Ù¾Ø± Ù†Ø´Ø¯ØŒ Ø¨Ù‡ ÛŒØ§Ø¯ Ù‡Ù… Ø¨Ø§Ø´ÛŒÙ… Ø´Ø§ÛŒØ¯ ÙØ±Ø¯Ø§ Ù…Ø§ Ù‡Ù… Ø¯Ø± Ú©Ù†Ø§Ø± Ù‡Ù… Ù†Ø¨Ø§Ø´ÛŒÙ…â€¦'),
(4, 'Ú©Ù¾ÙˆÛŒ Ø´Ù…Ø§Ù„ÛŒ', 3, 450000, 'kapoo.jpg', 'Ú©Ù¾Ùˆ Ù†ÙˆØ¹ÛŒ Ø¸Ø±Ù Ù†Ú¯Ù‡Ø¯Ø§Ø±Ù†Ø¯Ù‡ Ø¨Ø§ÙØªÙ‡ Ø´Ø¯Ù‡ Ø§Ø³Øª Ú©Ù‡ ØªÙˆØ³Ø· Ù…Ø±Ø¯Ù… Ø¹Ø²ÛŒØ² Ø®Ø·Ù‡â€ŒÛŒ Ø´Ù…Ø§Ù„ Ø§ÛŒØ±Ø§Ù†â€ŒÙ…Ø§Ù† Ø¨Ø§ÙØªÙ‡ Ùˆ ØªÙ‡ÛŒÙ‡ Ù…ÛŒØ´ÙˆØ¯.  Ù…Ø¯Ø§Ø¯ Ø±Ù†Ú¯ÛŒ Ù‡Ø§ Ù…Ø´ØºÙˆÙ„ Ø¨ÙˆØ¯Ù†Ø¯ Ø¨Ù‡ Ø¬Ø² Ù…Ø¯Ø§Ø¯ Ø³ÙÛŒØ¯ØŒ Ù‡ÛŒÚ†Ú©Ø³ Ø¨Ù‡ Ø§Ùˆ Ú©Ø§Ø± Ù†Ù…ÛŒØ¯Ø§Ø¯ØŒ Ù‡Ù…Ù‡ Ù…ÛŒÚ¯ÙØªÙ†Ø¯ : ØªÙˆ Ø¨Ù‡ Ù‡ÛŒÚ† Ø¯Ø±Ø¯ÛŒ Ù†Ù…ÛŒØ®ÙˆØ±ÛŒØŒ ÛŒÚ© Ø´Ø¨ Ú©Ù‡ Ù…Ø¯Ø§Ø¯ Ø±Ù†Ú¯ÛŒ Ù‡Ø§ ØªÙˆ Ø³ÛŒØ§Ù‡ÛŒ Ø´Ø¨ Ú¯Ù… Ø´Ø¯Ù‡ Ø¨ÙˆØ¯Ù†Ø¯ØŒ Ù…Ø¯Ø§Ø¯ Ø³ÙÛŒØ¯ ØªØ§ ØµØ¨Ø­ Ù…Ø§Ù‡ Ú©Ø´ÛŒØ¯ Ù…Ù‡ØªØ§Ø¨ Ú©Ø´ÛŒØ¯ Ùˆ Ø§Ù†Ù‚Ø¯Ø± Ø³ØªØ§Ø±Ù‡ Ú©Ø´ÛŒØ¯ Ú©Ù‡ Ú©ÙˆÚ†Ú© Ùˆ Ú©ÙˆÚ†Ú©ØªØ± Ø´Ø¯ ØµØ¨Ø­ ØªÙˆÛŒ Ø¬Ø¹Ø¨Ù‡ Ù…Ø¯Ø§Ø¯ Ø±Ù†Ú¯ÛŒ Ø¬Ø§ÛŒ Ø®Ø§Ù„ÛŒ Ø§Ùˆ Ø¨Ø§ Ù‡ÛŒÚ† Ø±Ù†Ú¯ÛŒ  Ù¾Ø± Ù†Ø´Ø¯ØŒ Ø¨Ù‡ ÛŒØ§Ø¯ Ù‡Ù… Ø¨Ø§Ø´ÛŒÙ… Ø´Ø§ÛŒØ¯ ÙØ±Ø¯Ø§ Ù…Ø§ Ù‡Ù… Ø¯Ø± Ú©Ù†Ø§Ø± Ù‡Ù… Ù†Ø¨Ø§Ø´ÛŒÙ…â€¦'),
(5, 'Ú©Ø§Ø³Ù‡ Ù‚Ù„Ù… Ø²Ù†ÛŒ Ø´Ø¯Ù‡', 2, 3300000, 'kase-ghalamzani.jpg', 'Ú©Ø§Ø³Ù‡ Ù‚Ù„Ù… Ø²Ù†ÛŒ Ø´Ø¯Ù‡. Ø§Ø² ØµÙ†Ø§ÛŒØ¹ Ø¯Ø³ØªÛŒ Ø²ÛŒØ¨Ø§ÛŒ Ø§ÛŒØ±Ø§Ù†. Ø¯Ø§Ø±Ø§ÛŒ Ø²ÛŒØ¨Ø§ ØªØ±ÛŒÙ† Ø·Ø±Ø­ Ù‡Ø§ÛŒ Ø§ØµÛŒÙ„ Ø§ÛŒØ±Ø§Ù†ÛŒ.  Ù…Ø¯Ø§Ø¯ Ø±Ù†Ú¯ÛŒ Ù‡Ø§ Ù…Ø´ØºÙˆÙ„ Ø¨ÙˆØ¯Ù†Ø¯ Ø¨Ù‡ Ø¬Ø² Ù…Ø¯Ø§Ø¯ Ø³ÙÛŒØ¯ØŒ Ù‡ÛŒÚ†Ú©Ø³ Ø¨Ù‡ Ø§Ùˆ Ú©Ø§Ø± Ù†Ù…ÛŒØ¯Ø§Ø¯ØŒ Ù‡Ù…Ù‡ Ù…ÛŒÚ¯ÙØªÙ†Ø¯ : ØªÙˆ Ø¨Ù‡ Ù‡ÛŒÚ† Ø¯Ø±Ø¯ÛŒ Ù†Ù…ÛŒØ®ÙˆØ±ÛŒØŒ ÛŒÚ© Ø´Ø¨ Ú©Ù‡ Ù…Ø¯Ø§Ø¯ Ø±Ù†Ú¯ÛŒ Ù‡Ø§ ØªÙˆ Ø³ÛŒØ§Ù‡ÛŒ Ø´Ø¨ Ú¯Ù… Ø´Ø¯Ù‡ Ø¨ÙˆØ¯Ù†Ø¯ØŒ Ù…Ø¯Ø§Ø¯ Ø³ÙÛŒØ¯ ØªØ§ ØµØ¨Ø­ Ù…Ø§Ù‡ Ú©Ø´ÛŒØ¯ Ù…Ù‡ØªØ§Ø¨ Ú©Ø´ÛŒØ¯ Ùˆ Ø§Ù†Ù‚Ø¯Ø± Ø³ØªØ§Ø±Ù‡ Ú©Ø´ÛŒØ¯ Ú©Ù‡ Ú©ÙˆÚ†Ú© Ùˆ Ú©ÙˆÚ†Ú©ØªØ± Ø´Ø¯ ØµØ¨Ø­ ØªÙˆÛŒ Ø¬Ø¹Ø¨Ù‡ Ù…Ø¯Ø§Ø¯ Ø±Ù†Ú¯ÛŒ Ø¬Ø§ÛŒ Ø®Ø§Ù„ÛŒ Ø§Ùˆ Ø¨Ø§ Ù‡ÛŒÚ† Ø±Ù†Ú¯ÛŒ  Ù¾Ø± Ù†Ø´Ø¯ØŒ Ø¨Ù‡ ÛŒØ§Ø¯ Ù‡Ù… Ø¨Ø§Ø´ÛŒÙ… Ø´Ø§ÛŒØ¯ ÙØ±Ø¯Ø§ Ù…Ø§ Ù‡Ù… Ø¯Ø± Ú©Ù†Ø§Ø± Ù‡Ù… Ù†Ø¨Ø§Ø´ÛŒÙ…â€¦'),
(6, 'Ú©Ø§Ø³Ù‡ Ø³Ù†ØªÛŒ', 5, 140000, 'kase-sonati.jpg', 'Ú©Ø§Ø³Ù‡ Ù‡Ø§ÛŒ Ø³Ù†ØªÛŒ. Ø¨Ø±Ø§ÛŒ Ø¹Ø²ÛŒØ²Ø§Ù†ÛŒ Ú©Ù‡ Ù‡Ù†Ø± Ùˆ ÙØ±Ù‡Ù†Ú¯ Ø§ÛŒØ±Ø§Ù†ÛŒ Ø¨Ø±Ø§ÛŒØ´Ø§Ù† Ø§Ø±Ø²Ø´Ù…Ù†Ø¯ Ø§Ø³Øª. Ø§ÛŒÙ† Ú©Ø§Ø³Ù‡ Ù‡Ø§ Ù†ØªÛŒØ¬Ù‡ Ø³Ø§Ø¹ØªÙ‡Ø§ Ø²Ø­Ù…Øª Ø§Ø³Øª.  Ù…Ø¯Ø§Ø¯ Ø±Ù†Ú¯ÛŒ Ù‡Ø§ Ù…Ø´ØºÙˆÙ„ Ø¨ÙˆØ¯Ù†Ø¯ Ø¨Ù‡ Ø¬Ø² Ù…Ø¯Ø§Ø¯ Ø³ÙÛŒØ¯ØŒ Ù‡ÛŒÚ†Ú©Ø³ Ø¨Ù‡ Ø§Ùˆ Ú©Ø§Ø± Ù†Ù…ÛŒØ¯Ø§Ø¯ØŒ Ù‡Ù…Ù‡ Ù…ÛŒÚ¯ÙØªÙ†Ø¯ : ØªÙˆ Ø¨Ù‡ Ù‡ÛŒÚ† Ø¯Ø±Ø¯ÛŒ Ù†Ù…ÛŒØ®ÙˆØ±ÛŒØŒ ÛŒÚ© Ø´Ø¨ Ú©Ù‡ Ù…Ø¯Ø§Ø¯ Ø±Ù†Ú¯ÛŒ Ù‡Ø§ ØªÙˆ Ø³ÛŒØ§Ù‡ÛŒ Ø´Ø¨ Ú¯Ù… Ø´Ø¯Ù‡ Ø¨ÙˆØ¯Ù†Ø¯ØŒ Ù…Ø¯Ø§Ø¯ Ø³ÙÛŒØ¯ ØªØ§ ØµØ¨Ø­ Ù…Ø§Ù‡ Ú©Ø´ÛŒØ¯ Ù…Ù‡ØªØ§Ø¨ Ú©Ø´ÛŒØ¯ Ùˆ Ø§Ù†Ù‚Ø¯Ø± Ø³ØªØ§Ø±Ù‡ Ú©Ø´ÛŒØ¯ Ú©Ù‡ Ú©ÙˆÚ†Ú© Ùˆ Ú©ÙˆÚ†Ú©ØªØ± Ø´Ø¯ ØµØ¨Ø­ ØªÙˆÛŒ Ø¬Ø¹Ø¨Ù‡ Ù…Ø¯Ø§Ø¯ Ø±Ù†Ú¯ÛŒ Ø¬Ø§ÛŒ Ø®Ø§Ù„ÛŒ Ø§Ùˆ Ø¨Ø§ Ù‡ÛŒÚ† Ø±Ù†Ú¯ÛŒ  Ù¾Ø± Ù†Ø´Ø¯ØŒ Ø¨Ù‡ ÛŒØ§Ø¯ Ù‡Ù… Ø¨Ø§Ø´ÛŒÙ… Ø´Ø§ÛŒØ¯ ÙØ±Ø¯Ø§ Ù…Ø§ Ù‡Ù… Ø¯Ø± Ú©Ù†Ø§Ø± Ù‡Ù… Ù†Ø¨Ø§Ø´ÛŒÙ…â€¦'),
(7, 'Ú©Ø§Ø´ÛŒ Ú©Ø§Ø±ÛŒ Ù‡ÙØª Ø±Ù†Ú¯', 13, 17000, 'kashi-haft-rang.jpg', 'Ø§ÛŒÙ† Ú©Ø§Ø´ÛŒ Ù‡Ø§ Ù…ÛŒØªÙˆØ§Ù†Ù†Ø¯ Ø§Ù„Ù…Ø§Ù† Ø¨Ø¬Ø§ÛŒÛŒ Ø¨Ø±Ø§ÛŒ Ø·Ø±Ø§Ø­ÛŒ Ø®Ø§Ù†Ù‡â€ŒØªØ§Ù† Ø¨Ø§Ø´Ù†Ø¯. Ø§ÛŒÙ† Ú©Ø§Ø´ÛŒ Ù‡Ø§ Ø­Ø§ÙˆÛŒ Ø·Ø±Ø­ Ùˆ Ø±Ù†Ú¯ Ù‡Ø§ÛŒ Ø§ØµÛŒÙ„ Ø§ÛŒØ±Ø§Ù†ÛŒ Ù‡Ø³ØªÙ†Ø¯.  Ù…Ø¯Ø§Ø¯ Ø±Ù†Ú¯ÛŒ Ù‡Ø§ Ù…Ø´ØºÙˆÙ„ Ø¨ÙˆØ¯Ù†Ø¯ Ø¨Ù‡ Ø¬Ø² Ù…Ø¯Ø§Ø¯ Ø³ÙÛŒØ¯ØŒ Ù‡ÛŒÚ†Ú©Ø³ Ø¨Ù‡ Ø§Ùˆ Ú©Ø§Ø± Ù†Ù…ÛŒØ¯Ø§Ø¯ØŒ Ù‡Ù…Ù‡ Ù…ÛŒÚ¯ÙØªÙ†Ø¯ : ØªÙˆ Ø¨Ù‡ Ù‡ÛŒÚ† Ø¯Ø±Ø¯ÛŒ Ù†Ù…ÛŒØ®ÙˆØ±ÛŒØŒ ÛŒÚ© Ø´Ø¨ Ú©Ù‡ Ù…Ø¯Ø§Ø¯ Ø±Ù†Ú¯ÛŒ Ù‡Ø§ ØªÙˆ Ø³ÛŒØ§Ù‡ÛŒ Ø´Ø¨ Ú¯Ù… Ø´Ø¯Ù‡ Ø¨ÙˆØ¯Ù†Ø¯ØŒ Ù…Ø¯Ø§Ø¯ Ø³ÙÛŒØ¯ ØªØ§ ØµØ¨Ø­ Ù…Ø§Ù‡ Ú©Ø´ÛŒØ¯ Ù…Ù‡ØªØ§Ø¨ Ú©Ø´ÛŒØ¯ Ùˆ Ø§Ù†Ù‚Ø¯Ø± Ø³ØªØ§Ø±Ù‡ Ú©Ø´ÛŒØ¯ Ú©Ù‡ Ú©ÙˆÚ†Ú© Ùˆ Ú©ÙˆÚ†Ú©ØªØ± Ø´Ø¯ ØµØ¨Ø­ ØªÙˆÛŒ Ø¬Ø¹Ø¨Ù‡ Ù…Ø¯Ø§Ø¯ Ø±Ù†Ú¯ÛŒ Ø¬Ø§ÛŒ Ø®Ø§Ù„ÛŒ Ø§Ùˆ Ø¨Ø§ Ù‡ÛŒÚ† Ø±Ù†Ú¯ÛŒ  Ù¾Ø± Ù†Ø´Ø¯ØŒ Ø¨Ù‡ ÛŒØ§Ø¯ Ù‡Ù… Ø¨Ø§Ø´ÛŒÙ… Ø´Ø§ÛŒØ¯ ÙØ±Ø¯Ø§ Ù…Ø§ Ù‡Ù… Ø¯Ø± Ú©Ù†Ø§Ø± Ù‡Ù… Ù†Ø¨Ø§Ø´ÛŒÙ…â€¦'),
(8, 'Ú©ÙˆØ²Ù‡ Ù…ÛŒÙ†Ø§Ú©Ø§Ø±ÛŒ', 2, 780000, 'kooze-minakari.jpg', 'Ø§ÛŒÙ† Ú©ÙˆØ²Ù‡ Ù‡Ø§ Ø¨Ø§ Ø±Ù†Ú¯ Ù‡Ø§ Ùˆ Ø·Ø±Ø­ Ù‡Ø§ÛŒ Ø§ØµÛŒÙ„ Ø§ÛŒØ±Ø§Ù†ÛŒ ØªÙ‡ÛŒÙ‡ Ùˆ ØªÙˆÙ„ÛŒØ¯ Ù…ÛŒØ´ÙˆÙ†Ø¯. Ø§Ø² Ù¾Ø±Ø·Ø±ÙØ¯Ø§Ø± ØªØ±ÛŒÙ† Ù…Ø­ØµÙˆÙ„ ØµÙ†Ø§ÛŒØ¹ Ø¯Ø³ØªÛŒ Ø§ÛŒØ±Ø§Ù†ÛŒ Ù‡Ø³ØªÙ†Ø¯.  Ù…Ø¯Ø§Ø¯ Ø±Ù†Ú¯ÛŒ Ù‡Ø§ Ù…Ø´ØºÙˆÙ„ Ø¨ÙˆØ¯Ù†Ø¯ Ø¨Ù‡ Ø¬Ø² Ù…Ø¯Ø§Ø¯ Ø³ÙÛŒØ¯ØŒ Ù‡ÛŒÚ†Ú©Ø³ Ø¨Ù‡ Ø§Ùˆ Ú©Ø§Ø± Ù†Ù…ÛŒØ¯Ø§Ø¯ØŒ Ù‡Ù…Ù‡ Ù…ÛŒÚ¯ÙØªÙ†Ø¯ : ØªÙˆ Ø¨Ù‡ Ù‡ÛŒÚ† Ø¯Ø±Ø¯ÛŒ Ù†Ù…ÛŒØ®ÙˆØ±ÛŒØŒ ÛŒÚ© Ø´Ø¨ Ú©Ù‡ Ù…Ø¯Ø§Ø¯ Ø±Ù†Ú¯ÛŒ Ù‡Ø§ ØªÙˆ Ø³ÛŒØ§Ù‡ÛŒ Ø´Ø¨ Ú¯Ù… Ø´Ø¯Ù‡ Ø¨ÙˆØ¯Ù†Ø¯ØŒ Ù…Ø¯Ø§Ø¯ Ø³ÙÛŒØ¯ ØªØ§ ØµØ¨Ø­ Ù…Ø§Ù‡ Ú©Ø´ÛŒØ¯ Ù…Ù‡ØªØ§Ø¨ Ú©Ø´ÛŒØ¯ Ùˆ Ø§Ù†Ù‚Ø¯Ø± Ø³ØªØ§Ø±Ù‡ Ú©Ø´ÛŒØ¯ Ú©Ù‡ Ú©ÙˆÚ†Ú© Ùˆ Ú©ÙˆÚ†Ú©ØªØ± Ø´Ø¯ ØµØ¨Ø­ ØªÙˆÛŒ Ø¬Ø¹Ø¨Ù‡ Ù…Ø¯Ø§Ø¯ Ø±Ù†Ú¯ÛŒ Ø¬Ø§ÛŒ Ø®Ø§Ù„ÛŒ Ø§Ùˆ Ø¨Ø§ Ù‡ÛŒÚ† Ø±Ù†Ú¯ÛŒ  Ù¾Ø± Ù†Ø´Ø¯ØŒ Ø¨Ù‡ ÛŒØ§Ø¯ Ù‡Ù… Ø¨Ø§Ø´ÛŒÙ… Ø´Ø§ÛŒØ¯ ÙØ±Ø¯Ø§ Ù…Ø§ Ù‡Ù… Ø¯Ø± Ú©Ù†Ø§Ø± Ù‡Ù… Ù†Ø¨Ø§Ø´ÛŒÙ…â€¦'),
(9, 'Ú©ÙˆØ²Ù‡ Ø³ÙØ§Ù„ÛŒ (Ø®Ø§Ú© Ø³ÙÛŒØ¯)', 15, 120000, 'kooze-sofali-khaksefid.jpg', 'Ú©ÙˆØ²Ù‡ Ù‡Ø§ÛŒ Ø¯Ø³ØªÛŒ Ø³ÙØ§Ù„ÛŒ Ø®Ø§Ú© Ø³ÙÛŒØ¯ Ú©Ù‡ Ù…Ù…Ú©Ù† Ø§Ø³Øª ØªØ§Ø­Ø§Ù„Ø§ Ù‡Ø²Ø§Ø±Ø§Ù† Ø¨Ø§Ø± Ø¯ÛŒØ¯Ù‡ Ø¨Ø§Ø´ÛŒØ¯.  Ù…Ø¯Ø§Ø¯ Ø±Ù†Ú¯ÛŒ Ù‡Ø§ Ù…Ø´ØºÙˆÙ„ Ø¨ÙˆØ¯Ù†Ø¯ Ø¨Ù‡ Ø¬Ø² Ù…Ø¯Ø§Ø¯ Ø³ÙÛŒØ¯ØŒ Ù‡ÛŒÚ†Ú©Ø³ Ø¨Ù‡ Ø§Ùˆ Ú©Ø§Ø± Ù†Ù…ÛŒØ¯Ø§Ø¯ØŒ Ù‡Ù…Ù‡ Ù…ÛŒÚ¯ÙØªÙ†Ø¯ : ØªÙˆ Ø¨Ù‡ Ù‡ÛŒÚ† Ø¯Ø±Ø¯ÛŒ Ù†Ù…ÛŒØ®ÙˆØ±ÛŒØŒ ÛŒÚ© Ø´Ø¨ Ú©Ù‡ Ù…Ø¯Ø§Ø¯ Ø±Ù†Ú¯ÛŒ Ù‡Ø§ ØªÙˆ Ø³ÛŒØ§Ù‡ÛŒ Ø´Ø¨ Ú¯Ù… Ø´Ø¯Ù‡ Ø¨ÙˆØ¯Ù†Ø¯ØŒ Ù…Ø¯Ø§Ø¯ Ø³ÙÛŒØ¯ ØªØ§ ØµØ¨Ø­ Ù…Ø§Ù‡ Ú©Ø´ÛŒØ¯ Ù…Ù‡ØªØ§Ø¨ Ú©Ø´ÛŒØ¯ Ùˆ Ø§Ù†Ù‚Ø¯Ø± Ø³ØªØ§Ø±Ù‡ Ú©Ø´ÛŒØ¯ Ú©Ù‡ Ú©ÙˆÚ†Ú© Ùˆ Ú©ÙˆÚ†Ú©ØªØ± Ø´Ø¯ ØµØ¨Ø­ ØªÙˆÛŒ Ø¬Ø¹Ø¨Ù‡ Ù…Ø¯Ø§Ø¯ Ø±Ù†Ú¯ÛŒ Ø¬Ø§ÛŒ Ø®Ø§Ù„ÛŒ Ø§Ùˆ Ø¨Ø§ Ù‡ÛŒÚ† Ø±Ù†Ú¯ÛŒ  Ù¾Ø± Ù†Ø´Ø¯ØŒ Ø¨Ù‡ ÛŒØ§Ø¯ Ù‡Ù… Ø¨Ø§Ø´ÛŒÙ… Ø´Ø§ÛŒØ¯ ÙØ±Ø¯Ø§ Ù…Ø§ Ù‡Ù… Ø¯Ø± Ú©Ù†Ø§Ø± Ù‡Ù… Ù†Ø¨Ø§Ø´ÛŒÙ…â€¦'),
